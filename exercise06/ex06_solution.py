...
for niter in range(0,100):
    ...
    if niter > 1:
        ...
        if ediff < 1e-5:
            ...
            # print the eigenvalues and -vectors to the terminal
            # note that the eigenvectors are column vectors with
            # respect to the coefficient matrix. This is not very
            # handy when reading the coefficients from the terminal
            # and hence we take the transpose of the coefficient
            # matrix by which the solution vectors will be row
            # vectors.
